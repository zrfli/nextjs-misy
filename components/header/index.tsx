    ...
    return (
        <nav className="bg-black fixed w-full z-20 top-0 start-0 border-b border-gray-700">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                <div className="flex font-medium md:order-2 space-x-3 md:space-x-5 rtl:space-x-reverse items-center">
                    ...
                    <Link href="/login" className="text-sm text-white bg-black hover:bg-gray-900 border border-gray-800 focus:outline-none rounded-lg text-sm px-4 py-2 text-center">Log In</Link>
                </div>
            </div>
        </nav>
    );
